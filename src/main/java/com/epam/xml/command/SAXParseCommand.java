...
import com.epam.xml.parsers.ProductsSAXParser;
import com.epam.xml.util.ConfigurationManager;
import javax.servlet.http.HttpServletRequest;
import javax.servlet.http.HttpServletResponse;

public final class SAXParseCommand implements ICommand{

    @Override
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        Products products = ProductsSAXParser.parse(XMLServlet.getPath() + ConfigurationManager.getStr("XML_PATH"));
