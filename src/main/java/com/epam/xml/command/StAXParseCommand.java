...
import com.epam.xml.parsers.ProductsStAXParser;
import com.epam.xml.util.ConfigurationManager;
import javax.servlet.http.HttpServletRequest;
import javax.servlet.http.HttpServletResponse;

public final class StAXParseCommand implements ICommand {

    @Override
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        Products products = ProductsStAXParser.parse(XMLServlet.getPath() + ConfigurationManager.getStr("XML_PATH"));
